    ...
    <section id="wsus__breadcrumb">
        <div class="wsus_breadcrumb_overlay">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h4>Sản phẩm của nhà cung cấp</h4>
                        <ul>
                            <li><a href="{{url('/')}}">Trang chủ</a></li>
                            <li><a href="javascrip:;">Sản phẩm của nhà cung cấp</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="wsus__pro_page_bammer vendor_det_banner">
                        ...
                        <div class="wsus__pro_page_bammer_text wsus__vendor_det_banner_text">
                            <div class="wsus__vendor_text_center">
                                ...
                                <p class="wsus__open_store"><i class="fab fa-shopify"></i> cửa hàng mởn</p>
                                <ul class="d-flex">
