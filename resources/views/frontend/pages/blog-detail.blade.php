                    ...
                    <div class="wsus__main_blog">
                        ...
                        <div class="wsus__share_blog">
                            ...
                            <ul>
                                ...
                                <li><a class="twitter"
                                        href="https://twitter.com/share?url={{ url()->current() }}&text=
                                "><i
                                            class="fab fa-twitter"></i></a></li>
                                <li><a class="linkedin"
                                        href="https://www.linkedin.com/shareArticle?url={{ url()->current() }}&title={{ $blog->title }}&summary={{ \Illuminate\Support\Str::limit($blog->description, 50) }}
                                "><i
                                        ...
                                        <div class="wsus__single_blog wsus__single_blog_2">
                                            ...
                                            <div class="wsus__blog_text">
                                                ...
                                                <div class="wsus__blog_text_center">
                                                    <a
                                                        href="{{ route('blog-details', $blogItem->slug) }}">{!! $blogItem->title !!}</a>
                                                    <p class="date">{{ date('M D Y', strtotime($blogItem->created_at)) }}
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
