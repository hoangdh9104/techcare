<div class="dashboard_sidebar">
    ...
    <ul class="dashboard_link">
      ...
      <li><a class="active" href="{{url('/')}}"><i class="fas fa-tachometer"></i>Go To Home Page</a></li>
      ...
      <li><a href="{{route('user.vendor-request.create')}}"><i class="far fa-user"></i> Request to be a vendor</a></li>
