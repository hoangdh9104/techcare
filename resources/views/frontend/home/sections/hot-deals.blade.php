                ...
                <div class="col-xl-12">
                    <div class="wsus__section_header justify-content-start">
                        <div class="monthly_top_filter2 mb-1">
                            <button class="active auto_click" data-filter=".new_arrival">Sản phẩm mới</button>
                        ...
                        <div class="col-xl-3 col-sm-6 col-lg-4 {{ $key }}">
                            <div class="wsus__product_item">
                                ...
                                <a class="wsus__pro_link" href="{{ route('product-detail', $product->slug) }}">
                                    ...
                                    <img src="{{ isset($product->productImageGalleries[0]) ? asset($product->productImageGalleries[0]->image) : asset($product->thumb_image) }}"
                                ...
                                <div class="wsus__product_details">
                                    ...
                                    <p class="wsus__pro_rating">
                                        ...
                                        <span>({{count($product->reviews)}} Xen sản phẩm)</span>
